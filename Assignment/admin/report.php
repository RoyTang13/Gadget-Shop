...
.filter-box input,.filter-box select{padding:8px;border-radius:8px;border:1px solid #c7d2fe}
.filter-box button{background:#6366f1;color:#fff;border:none;padding:8px 14px;border-radius:8px}
.summary{display:flex;gap:20px;margin-bottom:20px}
.summary div{flex:1;background:#eef2ff;padding:15px;border-radius:12px;text-align:center}
.order-table{width:100%;border-collapse:collapse;background:#fff}
.order-table th{background:#eef2ff;padding:12px}
.order-table td{padding:10px;border-bottom:1px solid #e5e7eb;text-align:center}
.status{padding:4px 10px;border-radius:12px;font-size:12px}
.status.pending{background:#fde68a}
.status.complete{background:#bbf7d0}
.status.cancelled{background:#fecaca}
.pagination{text-align:center;margin-top:15px}
.pagination a{padding:6px 10px;background:#e0e7ff;border-radius:6px;margin:0 3px;text-decoration:none}
